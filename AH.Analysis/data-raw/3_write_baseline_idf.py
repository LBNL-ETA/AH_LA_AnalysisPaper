...
WORK_FOLDER_NAME = 'scenario_simulation/idf_change_design_day' ## todo: modify the following code for new models
OUT_FOLDER_NAME = 'scenario_simulation/idf_add_sim_period_output'
